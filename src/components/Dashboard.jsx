...
const menuItems = [
  ...
  { path: "/organos-de-gobierno", text: "Órganos de Gobierno", icon: <BankOutlined /> },
  { path: "/sesiones-programadas", text: "Sesiones programadas", icon: <CalendarOutlined /> },
  { path: "/sesion-en-progreso", text: "Sesión en progreso", icon: <ClockCircleOutlined /> },
  ...
  { path: "/buzon-de-reportes", text: "Buzón de Reportes", icon: <MailOutlined /> },
  { path: "/login", text: "Login", icon: <MailOutlined /> },
];
